...
import com.liteafrica.meatexpress.VolleyMultipartRequest;
                                ...
                                new AlertDialog.Builder(SelectePaymentOption.this, R.style.AlertDialogTheme)
                                        ...
                                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog, int which) {
                                                ...
                                                mDatabase.child("Meat").child(con).child("Payment").setValue(String.valueOf(_pay));
                                                if (_pay == 2) {
                                                    mDatabase.child("Meat").child(con).child("Verify").setValue(String.valueOf(1));
                                                }
                                        ...
                                        new AlertDialog.Builder(SelectePaymentOption.this, R.style.AlertDialogTheme)
                                                ...
                                                .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                                    ...
                                                    public void onClick(DialogInterface dialog, int which) {
                                                        ...
                                                        String[] pars = pref.getUniqueRide().split("\\.");
                                                        String con = TextUtils.join("", pars);
                                                        mDatabase.child("Meat").child(con).child("Payment").setValue(String.valueOf(1));
                                                        pref.setPayment(2);
                                                        Intent i = new Intent(SelectePaymentOption.this, Canteen_Mainactivity.class);
                                                        startActivity(i);
                                                        finish();
