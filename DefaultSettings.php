...
function myFunction() {
  ...
  if(myVarFromPhp==''){
window.location.replace("http://139.59.38.160/GGKITCHEN/Dashboard/page-login.php");
  }else{
     if(error!=''){
      if(error==1){
                    ...
                    <li class="active">
                     ...
                     <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                           <li><i class="menu-icon fa fa-pencil-square-o"></i><a href="DefaultSettings.php">Settings</a></li>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="row">
                             ...
                             <div class="col col-md-3"><label for="text-input" class=" form-control-label">Minimum Order in Rs</label></div>
                             <div class="col-9 col-md-9"><input type="text" id="monimumorders" name="monimumorders" placeholder="Minimum order value in Rs" class="form-control"  ></div></div>       
                            ...
                            <div class="row form-group">
                             ...
                             <div class="col-9 col-md-9" style="margin: 10;"><input id="freedeldistance" name="freedeldistance" rows="9" placeholder="Delivery Free upto distance" class="form-control"></div></div>
                            
                             <div class="row form-group">
                              <div class="col col-md-3"><label for="text-input" class=" form-control-label">Delivery charge per KM</label></div>
                             <div class="col-9 col-md-9"><input type="text" id="price" name="price" placeholder="Price in Rs" class="form-control"  ></div></div>     <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">ORDER accept start time</label></div> 
                             <div class="col-9 col-md-9"><input type="time" id="starttime" name="starttime" placeholder="Time" class="form-control"  ></div></div>     <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">ORDER accept End time</label></div>
                             <div class="col-9 col-md-9"><input type="time" id="endtime" name="endtime" placeholder="Time" class="form-control"  ></div></div>     <div class="row form-group">
