        ...
        <div class="breadcrumbs">
            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                             ...
                             <div class="col-9 col-md-9"><input type="text" id="Name" name="Name" placeholder="Enter the name" class="input-sm form-control-sm form-control"  required></div></div>                                          
                  
                                                          <div class="row form-group">
                             <div class="col col-md-3"><label for="text-input" class=" form-control-label">Specification</label></div>
                             <div class="col-9 col-md-9"><input type="text" id="special" name="special" placeholder="Enter the specification" class="input-sm form-control-sm form-control"  required></div></div>      
            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                      ...
                      $conn = $db->connect();
                       ...
                       $users =$conn->query("SELECT `ID`, `Name`, `isActive`, `User`, `Date`, `Time` FROM `menu_type` WHERE `isActive`=1");
                        if(!empty($users)): $count = 0; foreach($users as $user): $count++;
                    ?>
                    <tr>
                        <td><?php echo $count; ?></td>
           <td><a href="EditPrimaryService.php?id=<?php echo $user['ID']; ?>" style="display:block;color: blue;"><u><?php echo $user['Name']; ?></u></a></td>
