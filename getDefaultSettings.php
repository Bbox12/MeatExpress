...
$sql="SELECT `ID`, `Discounts`, `MinimumOrderPrice`, `MinimumOrderWeight`, `MinimumDistance`, `MaximumDistance`, `StartTime`, `EndTime`, `FreeDistance`, `PricePerKM`, `Date`, `Time`, `User`, `IP` FROM `setting_defaults` ORDER BY ID DESC LIMIT 1";
