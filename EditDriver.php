...
function myFunction() {
  ...
  if(myVarFromPhp==''){
window.location.replace("http://139.59.38.160/Groom/Dashboard/page-login.php");
  }
};
</script>
</head>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                      ...
                      $conn = $db->connect();
                        ...
                        $users =$conn->query("SELECT `ID`, `Name`,`Phone_No`, `role`, `Address`, `Country`, `State`, `City`, `Pin` FROM `user_details` WHERE `role`=2  ORDER BY ID");
...
<td> <a href="Adddrivers.php?id=<?php echo $user["OrderID"];?>" style="color:blue;">Edit</a></td>
                    </tr>
                    <?php endforeach; else: ?>
